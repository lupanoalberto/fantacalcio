...
import GoalSvg from "@/assets/svg/events/gol.svg";
import PenaltyGoalSvg from "@/assets/svg/events/penalty-gol.svg";
import OwnGoalSvg from "@/assets/svg/events/own-gol.svg";
import YellowCardSvg from "@/assets/svg/events/yellow-card.svg";
import RedCardSvg from "@/assets/svg/events/red-card.svg";
import SubSvg from "@/assets/svg/events/sub.svg";
