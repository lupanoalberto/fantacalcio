...
{leagueLogo ? (
  <Image source={leagueLogo} style={{ width: 24, height: 24 }} />
) : null}
      ...
      {rows.map((row) => (
        ...
        >
          ...
          <View style={{
            ...
            <View style={{ flex: 1, justifyContent: "flex-start", alignItems: "center", gap: 6, }}>
              <Image source={LEAGUE_LOGOS[row.api_league_id]} style={{ width: 24, height: 24 }} />
              <Text
              style={{
                fontFamily: fonts.regular,
                color: colors.textSecondary,
