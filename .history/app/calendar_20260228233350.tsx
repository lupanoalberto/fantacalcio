    ...
    return (
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={{ gap: 8, paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.opacity }}
        >
          {matchdays.map((m) => (
            <TouchableOpacity
              key={m}
              style={[
                styles.button,
                { borderWidth: 1, borderColor: day === m ? colors.green : colors.opacity },
              ]}
              onPress={() => {
                selectDay(m);
              }}
        ...
        {/* 🔹 Match list */}
        <View style={{ flexDirection: "column", width: "100%", gap: 8, paddingHorizontal: 16, }}>
