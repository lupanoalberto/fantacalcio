...
const NATIONALITY: Record<string, any> = {
  ...
  "omania": require("@/assets/flags/romania.png"),
  "ussia": require("@/assets/flags/russia.png"),
  "ingapore": require("@/assets/flags/singapore.png"),
  "lovakia": require("@/assets/flags/slovakia.png"),
        ...
        >
          ...
          >
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                <Image
                  source={player?.nationality ? NATIONALITY[player?.nationality] : null}
          ...
          <View style={styles.section}>
            ...
            {statsLoading ? (
              ...
              >
                <StatCard
                  label="Presenze"
                  value={stats?.appearances == null ? "—" : String(stats.appearances)}
                  colors={colors}
                  fonts={fonts}
                />
                <StatCard
