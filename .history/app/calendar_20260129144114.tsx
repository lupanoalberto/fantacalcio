...
export default function CalendarScreen() {
  ...
  const renderMatchdays = () => {
    return (
      <View key={day} style={{ flexDirection:  }}>
        {/* 🔹 Trigger popup */}
        <TouchableOpacity
        ...
        >
          <Text
            style={{ color: colors.text, fontFamily: fonts.bold, fontSize: 12, }}
          >
            Giornata {day}
          </Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }} contentContainerStyle={{ gap: 24, }}>
        <View
          style={{
            width: "100%",
            flex: 1,
