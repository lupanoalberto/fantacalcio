...
export default function MatchDetails() {
  ...
  const getVoteStyle = (vote?: number) => {
    ...
    else return { backgroundColor: colors.gray, color: colors.text };
  };
          ...
          >
            <TouchableOpacity
              style={[
                styles.tabBtn,
                {
                  backgroundColor: isActive === 0 ? colors.white : colors.gray,
                },
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.tabBtn,
                {
                  backgroundColor: isActive === 1 ? colors.white : colors.gray,
                },
              ]}
                ...
                events.map((e: any, i: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TouchableOpacity onPress={() => router.push((`/player/${String(e.player.id)}`) as Href)}>
                        <Text
                        style={{
                      ...
                      <TouchableOpacity onPress={() => router.push((`/player/${String(e.player.id)}`) as Href)}></TouchableOpacity>
                      <Text
                        style={{
