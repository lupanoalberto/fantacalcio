            ...
            >
              <TouchableOpacity
                style={[
                  styles.button,
                  {
                    ...
                    backgroundColor: isActive === 0 ? colors.white : colors.opacity, 
                  },
                ]}
              ...
              >
                <Text
                  ...
                  style={{
                    fontSize: 12,
                    color: isActive === 0 ? colors.grorangeeen : colors.white,
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    borderWidth: 1,
                    backgroundColor: isActive === 1 ? colors.white : colors.opacity,
                  },
                ]}
