            ...
            {isActive === 0 ? (
              eventsLoading ? (
                ...
                events.map((e: any, i: number) => {
                  ...
                  if (e?.detail.includes("substitution")) isSub = true;
                  ...
                  return (
                    ...
                    >
                      ...
                      <View
                        style={{
                          flexDirection: isSub ? "row-reverse" : "row",
                          gap: 6,
                          justifyContent: "flex-start",
                          alignItems: "center",
                        }}
                      >
                        ...
                        >
                          {isSub ? `(${e.player.name})` : `${e.player.name}`}
                        </Text>
                        <Text
                          style={{
                        ...
                        >
                          {e.assist?.name && isSub ? `${e.assist.name}` : || e.assist?.name ? `(${e.assist.name})` || ""}
                        </Text>
                      </View>
                    </View>
                  );
