                    ...
                    {Array.isArray(l.startXI) && l.startXI.length > 0 ? (
                      <View style={{ width: "100%" }}>
                        {l.startXI.map((p: any, j: number) => (
                          ...
                          >
                            <View style={{ flexDirection: isHome === 0 ? "row" : "row-reverse", gap: 6, alignItems: "center", justifyContent: "flex-start" }}>
                              <Text
                                style={{
                                  flex: 1,
                                  color: colors.text,
                              ...
                              {/* INSERIRE IL VOTO DEL GIOCATORE CAMBIANDO COLORE IN BASE ALLA QUALITà del voto */}
                            </View>
                            <View style={{ flexDirection: isHome === 0 ? "row" : "row-reverse", gap: 6 }}>
                              {/* INSERIRE LE ICONE ALLE QUALI APPARTIENE IL GIOCATORE, gol, assist, sostituzione ecc... */}
                            </View>
                          </View>
                        ))}
                      </View>
