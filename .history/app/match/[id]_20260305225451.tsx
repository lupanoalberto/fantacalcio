...
export default function MatchDetails() {
  ...
  const league = useMemo(() => details?.league.name ?? null, [details]);
  ...
  const gotToPlayer = ( idPlayer : string ) => {
    router.push({
      pathname: "/player/[id]",
      params: { id: String(idPlayer), league: league },
    });
  };
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            >
              <MaterialCommunityIcons name="strategy" size={24} color={colors.text} />
              <Text
                numberOfLines={1}
                style={{
                  fontSize: 12,
                ...
                events.map((e: any, i: number) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TouchableOpacity onPress={() => gotToPlayer(e.player.id)}>
                        <Text
                          style={{
                      ...
                      <TouchableOpacity onPress={() => gotToPlayer(e.assist.id)}>
                        <Text
                          style={{
                            color: isSub ? colors.text : colors.text,
                            fontSize: 12,
                        ...
                        {l.startXI.map((p: any, j: number) => {
                          ...
                          return (
                            <TouchableOpacity
                              ...
                              onPress={() => gotToPlayer(p.player.id)}
                            >
                              <Text
                                style={{
                                  flex: 1,
