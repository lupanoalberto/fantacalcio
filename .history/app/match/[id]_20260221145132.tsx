...
export default function MatchDetails() {
  ...
  return (
    ...
    >
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 24 }}>
        <View
          style={{
            width: "100%",
            flex: 1,
            ...
            alignItems: "center",
            height: insets.top + 12 + 48 +24 +72 + 24,
            gap: 24,
            position: "relative",
            overflow: "hidden",
          }}
          ...
          >
            <TouchableOpacity
              style={[
                styles.tabBtn,
                {
                  borderBottomWidth: isActive === 0 ? 1 : 0,
            ...
            <TouchableOpacity
              style={[
                styles.tabBtn,
                {
                  borderBottomWidth: isActive === 1 ? 1 : 0,
                  borderColor: colors.success,
                },
              ]}
