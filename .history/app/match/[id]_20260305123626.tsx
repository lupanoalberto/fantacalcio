  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <View style={{ width: 72, height: 72, padding: 6, backgroundColor: colors.text, borderRadius: 12, }}>
          <Image
            source={{ uri: homeLogo }}
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <ScrollView
            ...
            contentContainerStyle={{ gap: 12, padding: 12, backgroundColor: colors. }}
          >
            <TouchableOpacity
              style={[
                styles.button,
                {
                  ...
                  backgroundColor:
                    isActive === 0 ? colors.text : colors.opacity,
                },
              ]}
            ...
            <TouchableOpacity
              style={[
                styles.button,
                {
                  ...
                  borderColor: colors.opacity,
                  backgroundColor:
                    isActive === 1 ? colors.text : colors.opacity,
                },
              ]}
