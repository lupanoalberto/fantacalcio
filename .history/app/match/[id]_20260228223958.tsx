    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          >
            <TouchableOpacity
              style={[
                ...
                {
                  borderWidth: 1,
                  borderColor: isActive === 0 ? colors.green : colors.opacity,
                },
              ]}
            ...
            <TouchableOpacity
              style={[
                ...
                {
                  borderWidth: 1,
                  borderColor: isActive === 1 ? colors.green : colors.opacity,
                },
              ]}
          ...
          <View
            style={{ flexDirection: isActive === 0 ? "column" : "row", gap: 4 }}
          >
            {isActive === 0 ? (
              eventsLoading ? (
              ...
              lineups.map((l: any, idx: number) => {
                ...
                return (
                  <View
                    key={idx}
                    style={{ width: "50%", flex: 1, flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: 4 }}
                  >
