...
export default function CalendarScreen() {
  ...
  return (
    ...
    >
      ...
      <ScrollView style={{ position: "fixed", bottom: 0, width: "100%", flexDirection: "column"  }}
      ...
      >
        {matchdays.map((m) => (
          <TouchableOpacity
            key={m}
            style={[
              { width: "100%", borderBottomWidth: 1, borderBottomColor: colors.opacity, padding: 8, paddingHorizontal: 16, },
            ]}
            onPress={() => {
              selectDay(m);
            }}
