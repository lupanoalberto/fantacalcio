...
export default function CalendarScreen() {
  ...
  const renderMatchdays = () => {
    return (
      <View key={day} style={{ gap: 12, }}>
        ...
        >
          <Text
            style={{ color: colors.text, fontFamily: fonts.semibold, fontSize: 12, }}
          >
            Giornata {day}
          </Text>
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingBottom: insets.bottom }}>
      <ScrollView style={{ flex: 1, backgroundColor: colors.background }} contentContainerStyle={{ gap: 24, paddingBottom: 12, }}>
        <View
          style={{
            width: "100%",
            flex: 1,
