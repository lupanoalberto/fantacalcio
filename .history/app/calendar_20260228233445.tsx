    ...
    return (
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={{ paddingHorizontal: 16, paddingVertical: 8, backgroundColor: colors.opacity }}
        >
          {matchdays.map((m) => (
            <TouchableOpacity
              key={m}
              style={[
                styles.button,
                { borderRightWidth: 1, borderColor: day === m ? colors.green : colors.opacity },
              ]}
              onPress={() => {
                selectDay(m);
              }}
