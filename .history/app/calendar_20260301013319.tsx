  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ backgroundColor: colors.white }}>
            {matchdays.map((m) => (
              <TouchableOpacity
                key={m}
                style={[
                  {
                    ...
                    padding: 8,
                    paddingHorizontal: 16,
                    backgroundColor: m === day ? colors.orange : "transparent",
                  },
                ]}
                onPress={() => {
                  selectDay(m);
              ...
              >
                <Text
                  style={{
                    color: day === m ? colors.dark : colors.text,
