...
const LEAGUE_LOGOS: Record<string, any> = {
  "Serie A": require("@/assets/img/135 1.png"),
  "Premier League": require("@/assets/img/39 1.png"),
  "LaLiga": require("@/assets/img/laliga.png"),
  "Bundesliga": require("@/assets/img/78 1.png"),
  "Ligue 1": require("@/assets/img/61 1.png"),
};
