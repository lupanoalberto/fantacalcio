    ...
    >
      ...
      >
        <ScrollView
          ...
          contentContainerStyle={{ backgroundColor: colors.card, padding: 12, gap: 12, }}
        >
          <TouchableOpacity
            style={[
              {
                ...
                gap: 6,
                borderRadius: 12,
                backgroundColor: isActive === 0 ? colors.primary : colors.opacity,
              },
            ]}
            onPress={() => {
              setIsActive(0);
            ...
            style={[
              {
                ...
                gap: 6,
                borderRadius: 12,
                backgroundColor: isActive === 1 ? colors.primary : colors.opacity,
              },
            ]}
            onPress={() => {
              setIsActive(1);
            ...
            style={[
              {
                ...
                gap: 6,
                borderRadius: 12,
                backgroundColor: isActive === 2 ? colors.primary : colors.opacity,
              },
            ]}
            onPress={() => {
              setIsActive(2);
            ...
            style={[
              {
                ...
                gap: 6,
                borderRadius: 12,
                backgroundColor: isActive === 3 ? colors.primary : colors.opacity,
              },
            ]}
            onPress={() => {
              setIsActive(3);
            ...
            style={[
              {
                ...
                gap: 6,
                borderRadius: 12,
                backgroundColor: isActive === 4 ? colors.primary : colors.opacity,
              },
            ]}
            onPress={() => {
              setIsActive(4);
        ...
        <View style={styles.section}>
          ...
          {isActive === 0 ? (
            ...
            <StandignsSection selectedLeague={CURRENT_LEAGUE} />
          ) : isActive === 0 ? (
            <LiveMatchesSection selectedLeague={CURRENT_LEAGUE} />
          ) : (
            <LiveMatchesSection selectedLeague={CURRENT_LEAGUE} />
