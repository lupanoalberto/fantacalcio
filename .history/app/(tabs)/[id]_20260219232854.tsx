        ...
        <View style={styles.section}>
          ...
          <View style={styles.containerWrap}>
            <TouchableOpacity style={styles.button} onPress={goToCalendar}>
              <Ionicons name="calendar-outline" size={24} color={colors.back} />
              <Text
                numberOfLines={1}
                style={{
                  fontSize: 12,
            ...
            <TouchableOpacity style={styles.button} onPress={gotToStandings}>
              <MaterialCommunityIcons
                name="trophy-outline"
                size={24}
                color={colors.back}
            ...
            <TouchableOpacity style={styles.button} onPress={gotToPlayers}>
              <Ionicons name="shirt-outline" size={24} color={colors.back} />
              <Text
                numberOfLines={1}
                style={{
                  fontSize: 12,
