    ...
    >
      ...
      >
        <TouchableOpacity onPress={goBack} style={styles.button}>
          <Ionicons name="arrow-back" size={24} color={isActive === 0 ? colors.background : colors.text} />
        </TouchableOpacity>
        <Image
        source={leagueLogo}
          style={{
      ...
      >
        ...
        >
          ...
          >
            <MaterialIcons name="live-tv" size={24} color={isActive === 0 ? colors.background : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
                color: isActive === 0 ? colors.background : colors.text,
          ...
          >
            <Ionicons name="calendar-outline" size={24} color={isActive === 0 ? colors.background : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          >
            <Ionicons name="shirt-outline" size={24} color={isActive === 0 ? colors.background : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          >
            <Ionicons name="bandage-outline" size={24} color={isActive === 0 ? colors.background : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
