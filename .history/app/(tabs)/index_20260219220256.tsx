    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          >
            Esplora i campionati principali
          </Text>
          <ScrollView
          ...
          >
            ...
            >
              <Image
                source={require("@/assets/img/logo/background-card-serie-a.png")}
            ...
            >
              <Image
                source={require("@/assets/img/logo/background-card-premier-league.png")}
                style={styles.leagueImage}
              />
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Image
                source={require("@/assets/img/logo/background-card-laliga.png")}
                style={styles.leagueImage}
              />
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Image
                source={require("@/assets/img/logo/background-card-bundesliga.png")}
                style={styles.leagueImage}
              />
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Image
                source={require("@/assets/img/logo/background-card-ligue-1.png")}
                style={styles.leagueImage}
              />
            </TouchableOpacity>
          </ScrollView>
