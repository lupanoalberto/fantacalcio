    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View>
            <LiveMatchesSection selectedLeague="Serie A" error={false}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Premier League" error={false}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="LaLiga" error={false}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Bundesliga" error={false}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Ligue 1" error={false}></LiveMatchesSection>
          </View>
        </View>
      </ScrollView>
    </View>
