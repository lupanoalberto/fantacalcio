  ...
  return (
    ...
    >
      ...
      >
        ...
        <TouchableOpacity
          style={[styles.button, { borderWidth: 2, borderColor: colors.white }]}
      ...
      >
        <ScrollView
          showsVerticalScrollIndicator={false}
          contentContainerStyle={{ gap: 24, paddingHorizontal: 12, flexDirection: "row" }}
        >
          <TouchableOpacity
            style={[styles.button, { borderWidth: 2, borderColor: colors.opacity }]}
          >
