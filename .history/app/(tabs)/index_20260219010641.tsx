...
export default function LeagueDashboardScreen() {
  ...
  return (
    ...
    >
      <ScrollView style={[styles.container, { gap: 24 }]}>
        <View style={styles.section}>
          ...
          >
            <View style={{ width: 48, height: 48, borderRadius: 12, backgroundColor: colors.textSecondary }}></View>
            <Text
              style={
                { fontSize: 14, color: colors.text, fontFamily: fonts.semibold }}
            >
              {userLabel}
            </Text>
          </TouchableOpacity>
