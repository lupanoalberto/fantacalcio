...
const handleHasMatches = (league: string) => (has: boolean) => {
  setLiveMap((m) => ({ ...m, [league]: has }));
  setLoadedMap((m) => ({ ...m, [league]: true }));
};

const allLoaded = LEAGUES.every((l) => loadedMap[l] === true);
const hasAnyLiveMatch = LEAGUES.some((l) => liveMap[l] === true);
