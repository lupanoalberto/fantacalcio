...
const LEAGUE_LOGOS: Record<string, any> = {
  "Serie A": require("@/assets/img/logo/background-cardserie-a.png"),
  "Premier League": require("@/assets/img/logo/background-cardpremier-league.png"),
  LaLiga: require("@/assets/img/logo/background-cardlaliga.jpg"),
  Bundesliga: require("@/assets/img/logo/background-cardbundesliga.png"),
  "Ligue 1": require("@/assets/img/logo/background-cardligue-1.png"),
};
    ...
    >
      <ScrollView style={styles.container}>
        ...
        >
          ...
          <Image
              source={String(`/assets/img/logo/background-card-${CURRENT_LEAGUE}.png`) as any}
              style={{ width: "100%" }}
              resizeMode="contain"
            />
        </View>
