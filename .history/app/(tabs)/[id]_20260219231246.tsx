  ...
  return (
    ...
    >
      <ScrollView style={styles.container}>
        ...
        >
          <TouchableOpacity
            style={[styles.button, { backgroundColor: colors.text, position: "absolute", top: insets.top + 12, left: 12, zIndex: 10 }]}
            onPress={() => goBack()}
          >
            <Ionicons
            ...
            <Text
              style={[
                styles.textButton,
                { color: colors.background, fontFamily: fonts.semibold },
              ]}
            >
              Indietro
            </Text>
