      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.containerWrap}>
            <TouchableOpacity style={[styles.button, { backgroundColor: colors.text }]} onPress={goToCalendar}>
            ...
            <TouchableOpacity style={[styles.button, { backgroundColor: colors.text }]} onPress={gotToStandings}>
              <MaterialCommunityIcons
                name="trophy-outline"
                size={24}
                color={colors.background}
            ...
            <TouchableOpacity style={[styles.button, { backgroundColor: colors.text }]} onPress={gotToPlayers}>
