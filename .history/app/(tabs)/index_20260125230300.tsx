      ...
      <ScrollView style={[styles.container, { paddingVertical: 12, gap: 12, }]}>
        <View style={styles.containerButtons}>
          <TouchableOpacity style={styles.button}>
            ...
            <Text style={[styles.textButton, { color: Colors.text, fontFamily: Fonts.semibold }]}>
              Profilo
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button}>
        ...
        <View style={styles.section}>
          <Text style={[styles.textSection, { color: Colors.text, fontFamily: Fonts.semibold }]}>
          ...
          >
            <TouchableOpacity style={styles.leagueButton} onPress={() => router.push((`/notifications/${String(notif.id)}`) as Href)}>
              <Image source={require("@/assets/img/serie-a.png")} style={styles.leagueImage} />
            </TouchableOpacity>
          </ScrollView>
        </View>
