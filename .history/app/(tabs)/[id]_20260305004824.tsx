    ...
    >
      ...
      >
        <TouchableOpacity onPress={goBack} style={styles.button}>
          <Ionicons name="arrow-back" size={24} color={isActive colors.background} />
        </TouchableOpacity>
        <Image
        source={leagueLogo}
          style={{
      ...
      >
        ...
        >
          ...
          >
            <MaterialIcons name="live-tv" size={24} color={isActive colors.background} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          >
            <Ionicons name="calendar-outline" size={24} color={isActive colors.background} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          >
            <Ionicons name="shirt-outline" size={24} color={isActive colors.background} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
