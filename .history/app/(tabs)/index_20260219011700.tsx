...
export default function LeagueDashboardScreen() {
  ...
  return (
    ...
    >
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false} contentContainerStyle={{ gap: 16, paddingVertical: 16 }}>
        ...
        <View style={[styles.section, { paddingHorizontal: 16 }]}>
          <TouchableOpacity style={{ width: "100%", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }} onPress={() => router.push("/leagues/create" as Href)}>
