...
const LEAGUE_LOGOS: Record<string, any> = {
  "Serie A": require("@/assets/img/logo/backgserie-a.png"),
  "Premier League": require("@/assets/img/logo/backgpremier-league.png"),
  LaLiga: require("@/assets/img/logo/backglaliga.jpg"),
  Bundesliga: require("@/assets/img/logo/backgbundesliga.png"),
  "Ligue 1": require("@/assets/img/logo/backgligue-1.png"),
};
