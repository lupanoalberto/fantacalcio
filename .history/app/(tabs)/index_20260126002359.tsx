    ...
    >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View>
            <LiveMatchesSection selectedLeague="Serie A" onHasMatches={handleHasMatches}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Premier League" onHasMatches={handleHasMatches}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="LaLiga" onHasMatches={handleHasMatches}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Bundesliga" onHasMatches={handleHasMatches}></LiveMatchesSection>
          </View>
          <View>
            <LiveMatchesSection selectedLeague="Ligue 1" onHasMatches={handleHasMatches}></LiveMatchesSection>
          </View>
        </View>
      </ScrollView>
    </View>
