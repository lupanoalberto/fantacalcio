    ...
    >
      ...
      >
        <TouchableOpacity onPress={goBack} style={styles.button}>
          <Ionicons name="arrow-back" size={24} color={isActive === 0 ? colors.primary : colors.text} />
        </TouchableOpacity>
        <Image
        source={leagueLogo}
          style={{
        ...
        >
          <TouchableOpacity
            style={[
              ...
              { borderBottomWidth: 1, borderColor: isActive === 0 ? colors.primary : "transparent" },
            ]}
            onPress={() => { setIsActive(0) }}
          >
            <MaterialIcons name="live-tv" size={24} color={isActive === 0 ? colors.primary : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          <TouchableOpacity
            style={[
              ...
              { borderBottomWidth: 1, borderColor: isActive === 1 ? colors.primary : "transparent" },
            ]}
            onPress={() => { setIsActive(1) }}
          >
            <Ionicons name="calendar-outline" size={24} color={isActive === 1 ? colors.primary : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          <TouchableOpacity
            style={[
              ...
              { borderBottomWidth: 1, borderColor: isActive === 2 ? colors.primary : "transparent" },
            ]}
          ...
          <TouchableOpacity
            style={[
              ...
              { borderBottomWidth: 1, borderColor: isActive === 3 ? colors.primary : "transparent" },
            ]}
            onPress={() => { setIsActive(3) }}
          >
            <Ionicons name="shirt-outline" size={24} color={isActive === 3 ? colors.primary : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
          ...
          <TouchableOpacity
            style={[
              ...
              { borderBottomWidth: 1, borderColor: isActive === 4 ? colors.primary : "transparent" },
            ]}
            onPress={() => { setIsActive(4) }}
          >
            <Ionicons name="bandage-outline" size={24} color={isActive === 4 ? colors.primary : colors.text} />
            <Text
              numberOfLines={1}
              style={{
                fontSize: 12,
