...
export default function CalendarScreen() {
  ...
  return (
    ...
    >
      ...
      >
        <BlurView
    intensity={16}
    tint="dark" // oppure "light" in base al tuo design
    style={{
      position: "absolute",
      top: 0,
      left: 0,
  ...
  />
              ...
              style={[
                {
                  ...
                  padding: 8,
                  paddingHorizontal: 16,
                  backgroundColor: m === day ? colors.opacity : "transparent",
                },
              ]}
              onPress={() => {
                selectDay(m);
      ...
      <ScrollView
        ...
        showsVerticalScrollIndicator={false}
        contentContainerStyle={{ gap: 24, paddingVertical: 24, paddingBottom: 160 + 8, }}
      >
        {loading ? (
