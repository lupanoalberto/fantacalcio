...
export default function CreateLeagueScreen() {
  ...
  // ✅ ORA IL CAMPIONATO SI SCEGLIE QUI (inizio impostazioni lega)
  ...
  async function onCreate() {
    ...
    const scoring_json = {
      ...
      special: {
        ...
        woodwork: { value: enWoodwork ? toNumberOr(ptsWoodwork, 0.5) : 0, enabled: enWoodwork },
        penalty_won: { value: enPenWon ? toNumberOr(ptsPenWon, 0.5) : 0, enabled: enPenWon },
        penalty_conceded: {
  ...
  const SpecialRow = ({
    ...
    <View style={{ paddingVertical: 8, paddingHorizontal: 16 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          {hint ? (
            <Text
              style={[
                styles.sectionTitle,
                { color: colors.secondary, fontFamily: fonts.semibold, fontSize: 10 },
              ]}
            >
              {hint}
            </Text>
      ...
      <Field label="Valore" value={value} onChangeText={onChangeText} disabled={!enabled} keyboardType="default" />
    </View>
  );
      ...
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ borderWidth: 1, borderRadius: 16, padding: 16, margin: 16 }}>
          ...
          <View style={{ paddingTop: 8, gap: 8 }}>
            ...
            <Field label="Nome squadra" value={joinTeamName} onChangeText={setJoinTeamName} placeholder="Es. I Fenomeni" />
          </View>
          ...
          >
            {joining ? <ActivityIndicator /> : <Text style={{ color: colors.text, fontFamily: fonts.semibold, fontSize: 12 }}>Unisciti</Text>}
          </Pressable>
        </View>

        <Text style={[styles.sectionTitle, { color: colors.primary, fontFamily: fonts.semibold, paddingHorizontal: 16, fontSize: 14 }]}>
          Crea una nuova lega
        </Text>

        <Text style={[styles.sectionTitle, { color: colors.secondary, fontFamily: fonts.semibold, paddingHorizontal: 16, fontSize: 12 }]}>
          Campionato: {selectedLeague ?? "—"} • Stagione: {season}
        </Text>

        <View style={{ paddingHorizontal: 16, paddingVertical: 8, gap: 8 }}>
          {/* ✅ SELEZIONE CAMPIONATO (qui, non da params) */}
          <Text style={[styles.sectionTitle, { color: colors.primary, fontFamily: fonts.semibold }]}>
            Campionato
          </Text>
        ...
        {/* ... (resto del file invariato: regole, quote, bonus/malus, speciali) ... */}
        ...
        >
          {loading ? <ActivityIndicator /> : <Text style={{ color: colors.text, fontFamily: fonts.semibold, fontSize: 12 }}>Crea Lega</Text>}
        </Pressable>
      </ScrollView>
    </View>
  );
