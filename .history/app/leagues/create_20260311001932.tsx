    ...
    <View style={{ paddingVertical: 8, paddingHorizontal: 16 }}>
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
        <View style={{ flex: 1 }}>
          ...
          {hint ? (
            <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: fonts.semibold, fontSize: 10 }]}>
              {hint}
            </Text>
          ) : null}
        </View>
    ...
    <View style={{ flex: 1, paddingBottom: insets.bottom }}>
      <ScrollView style={{ flex: 1 }}>
        ...
        <Text
          style={[
            styles.sectionTitle,
            { color: colors.text, fontFamily: fonts.semibold, paddingHorizontal: 16, fontSize: 12 },
          ]}
        >
            ...
            {leagueOptions.map((l) => {
              ...
              return (
                <Pressable
                  ...
                  style={{
                    borderWidth: 1,
                    borderColor: active ? colors.success : colors.text,
          ...
          <View>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 8 }}>
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.sectionTitle, { color: colors.text, fontFamily: fonts.regular, fontSize: 10 }]}>
