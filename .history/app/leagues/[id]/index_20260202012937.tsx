    ...
    >
      <ScrollView style={styles.container} contentContainerStyle={{ gap: 24 }}>
        ...
        <View style={styles.section}>
          ...
          <TouchableOpacity style={{ flexDirection: "row", gap: 12, justifyContent: "center", alignItems: "center", width: "100%", padding: 12 }} onPress={goToLineup}>
        ...
        <View style={styles.section}>
          ...
          >
            ...
            <TouchableOpacity style={styles.leagueButton} onPress={goToTeams}>
              <View style={styles.logoContainer}>
                <MaterialCommunityIcons
                  name="shield-outline"
                  size={36}
            ...
            <TouchableOpacity style={styles.leagueButton}>
              <View style={styles.logoContainer}>
                <FontAwesome name="exchange" size={36} color={colors.text} />
              </View>
              <Text
                numberOfLines={1}
                style={{
