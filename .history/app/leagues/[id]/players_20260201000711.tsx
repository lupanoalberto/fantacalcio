...
export default function LeaguePlayersScreen() {
  ...
  // ✅ Nuovi controlli UI
  const [roleFilter, setRoleFilter] = useState<CanonicalRole>("Attaccante");
  ...
  async function addPlayerToMyTeam(player: CompetitionPlayer) {
    try {
      ...
      const payload = {
        ...
        player_name: player.name, // se non esiste in tabella, rimuovilo
        role: mapRole(player.position) ?? null, // se non esiste, rimuovilo
      };
        ...
        {loading ? (
          ...
          <>
            ...
            <View style={{ paddingHorizontal: 12, gap: 12 }}>
              ...
              >
                <RoleButton label="POR" role="Portiere" />
                <RoleButton label="DIF" role="Difensore" />
                <RoleButton label="CEN" role="Centrocampista" />
                <RoleButton label="ATT" role="Attaccante" />
              </View>
