...
export default function MatchScreen() {
  ...
  const activeTeamName =
    tab === "HOME" ? homeTeam?.name ?? "Casa" : awayTeam?.name ?? "Trasferta";
        ...
        <View style={{ alignItems: "flex-end", gap: 6 }}>
          ...
          <Text
            style={{
              fontSize: 12,
              fontFamily: fonts.bold,
              color: colors.white ?? colors.text,
            }}
          >
  ...
  return (
    ...
    >
      ...
      <LinearGradient
        colors={["#0d0d0d", colors.background, colors.orange, colors.background]}
        start={{ x: 0, y: 1 }}
        end={{ x: 1, y: 0 }}
        style={{ flex: 1 }}
      >
            ...
            <View style={{ paddingHorizontal: 16, paddingTop: 8 }}>
              ...
              >
                ...
                <View style={{ alignItems: "center", gap: 4 }}>
                  ...
                  >
                    G{match.matchday} • {statusLabel(match.status)}
                  </Text>
                  <Text
                    style={{
                      fontSize: 16,
                ...
                <TouchableOpacity
                  style={[
                    styles.pill,
                    {
                      borderWidth: 1,
                      borderColor: colors.opacity,
                      backgroundColor: tab === "HOME" ? colors.white : colors.opacity,
                    },
                  ]}
                  onPress={() => setTab("HOME")}
                  activeOpacity={0.85}
                ...
                <TouchableOpacity
                  style={[
                    styles.pill,
                    {
                      borderWidth: 1,
                      borderColor: colors.opacity,
                      backgroundColor: tab === "AWAY" ? colors.white : colors.opacity,
                    },
                  ]}
                  onPress={() => setTab("AWAY")}
                  activeOpacity={0.85}
