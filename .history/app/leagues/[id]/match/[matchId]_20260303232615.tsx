        ...
        {loading ? (
          ...
          >
            <MatchCard
              ...
              homeLogo={""}
              awayLogo={""}
              day={"Giornata " + String(match.matchday)}
            />
            ...
            >
              ...
              <View style={{ flex: 1 }}>
                ...
                {homeSplit.starters.map((p) => (
                  <PlayerRow key={`${p.lineup_id}-${p.api_player_id}`} p={p} />
                ))}
        ...
        >
          ...
          >
            ...
            <Text style={{ marginTop: 8, color: colors.text }}>
              Gol: {playerModal?.stat?.goals ?? 0}
            </Text>

            <Text style={{ color: colors.text }}>
              Assist: {playerModal?.stat?.assists ?? 0}
            </Text>

            <Text style={{ color: colors.text }}>
              Gialli: {playerModal?.stat?.yellow ?? 0}
            </Text>

            <Text style={{ color: colors.text }}>
              Rossi: {playerModal?.stat?.red ?? 0}
            </Text>

            <Text style={{ marginTop: 12, color: colors.text }}>
              Voto base: {safeNum(playerModal?.stat?.rating, 0)}
            </Text>
