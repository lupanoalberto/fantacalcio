      ...
      >
        ...
        >
          ...
          <View style={styles.section}>
            ...
            <View style={{ width: "100%", flexDirection: "row", gap: 4, paddingHorizontal: 16, }}>
              <View
                      style={{ width: "50%", flexDirection: "column", gap: 4 }}
                    >
                      {homePlayers.map((p) => (
                        <StarterRow key={`${p.lineup_id}-${p.api_player_id}-${p.slot}`} p={p} ></StarterRow>
<TouchableOpacity
                                key={p.api_player_id}
                                style={{
                                  flexDirection: "row",
                                ...
                                onPress={() =>
                                  router.push(
                                    `/player/${String(p.api_player_id)}` as Href,
                                  )
                                }
                              >
                                <Text
